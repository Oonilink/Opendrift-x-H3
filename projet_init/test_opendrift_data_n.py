...
reader_arome = reader_netCDF_CF_generic.Reader('simulations/data_in/wind.nc')
reader_cmems = reader_netCDF_CF_generic.Reader('simulations/data_in/curents_cmems.nc')
o.add_reader([reader_cmems, reader_arome, reader_landmask])  # ← LIGNE 3 (modifiée)
...
o.seed_elements(lon=-1, lat=50, radius=50, number=10, time=time_common, object_type=object_type)
